...
public class FacilityController {
    ...
    @GetMapping("list")
    public Result<List<FacilityInfo>> listFacility(@RequestParam(required = false)ItemType itemType){
        LambdaQueryWrapper<FacilityInfo> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(itemType!=null,FacilityInfo::getType,itemType);
